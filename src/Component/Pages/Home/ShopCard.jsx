               ...
               <div className=' p-2 items-center   mx-auto md:grid grid-cols-2  gap-5 my-4 '>
                              ...
                              <div className=' space-y-3 '>
                                   ...
                                   <div className=' md:flex justify-between gap-1  items-center'>
                                        ...
                                        />
                                        <small className=' text-xl font-semibold '> Rating: {rating} </small>
                                   </div>

                                   <button  className=' bg-blue-600 text-xl font-semibold text-white text-center py-1 px-3 rounded-lg my-2'> <Link onClick={handlePriveteRoute} to={`/shopdetils/${_id}`}> View Details  <FaArrowRight className=' inline-block mx-1'></FaArrowRight> </Link>  </button>
                              </div>
